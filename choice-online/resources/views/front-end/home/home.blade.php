                            ...
                            <ul>
                                ...
                                <li data-index="rs-16" data-transition="zoomout" data-slotamount="default"  data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="2000"  data-thumb="{!! asset('/') !!}/front-end/images/slide-img1.jpg"  data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off"  data-title="Intro" data-description="">
                                    ...
                                    <div class="tp-caption NotGeneric-Title   tp-resizeme rs-parallaxlevel-0"
                                         ...
                                         style="z-index: 5; white-space: nowrap;">SEASON SALE
                                    </div>
                                    <!-- LAYER NR. 2 -->
                                    <div class="tp-caption NotGeneric-SubTitle   tp-resizeme rs-parallaxlevel-0"
                                         ...
                                         data-splitout="none"
                                         data-responsive_offset="on"
                                         style="z-index: 6; white-space: nowrap;">Choice Online ecommerce store is updated regularly with offers.
                                    </div>
                                    <!-- LAYER NR. 3 -->
                                    ...
                                    <div class="tp-caption NotGeneric-Icon   tp-resizeme rs-parallaxlevel-1"
                                         ...
                                         data-splitout="none"
                                         data-responsive_offset="on"
                                         style="z-index: 7; white-space: nowrap;"><a href="#">Learn More</a>
                                    </div>
                                </li>
                                <!-- SLIDE  -->
                                <!-- SLIDE  -->
                                ...
                                <li data-index="rs-19" data-transition="zoomout" data-slotamount="default"  data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="2000"  data-thumb="{!! asset('/') !!}/front-end/images/video-img.jpg"  data-rotate="0"  data-saveperformance="off"  data-title="HTML5 Video" data-description="">
                                    ...
                                    <div class="tp-caption NotGeneric-Icon   tp-resizeme rs-parallaxlevel-0"
                                         ...
                                         data-splitout="none"
                                         data-responsive_offset="on"
                                         style="z-index: 8; white-space: nowrap;"><i class="pe-7s-ball"></i>hello
                                    </div>
                                </li>
                                <!-- SLIDE  -->
                            </ul>
                ...
                <div class="slider-items-products container">
                    ...
                    <div id="featured-slider" class="product-flexslider hidden-buttons">
                        <div class="slider-items slider-width-col4 products-grid">
                            {{-- this loop is call from AppServiceProvider--}}
                            @foreach($products as $product)
                                <div class="item">
                                    <div class="item-inner">
                                        <div class="item-img">
                                            <div class="item-img-info"> <a class="product-image" title="Retis lapen casen" href="{!! route('product-details',['id'=>$product->id,'name'=>$product->product_name]) !!}">
                                                    <img alt="Retis lapen casen" src="{!! asset($product->product_image) !!}"> </a>
                                                ...
                                                <div class="actions">
                                                    ...
                                                    <div class="link-wishlist">
                                                        <a href="{!! route('product-details',['id'=>$product->id,'name'=>$product->product_name]) !!}" data-toggle="tooltip" data-placement="right" title="" data-original-title="Product Details"><span>Product Details</span></a>
                                                    </div>
                                        ...
                                        <div class="item-info">
                                            <div class="info-inner">
                                                <div class="item-title"> <a title="Retis lapen casen" href="#"> {!! $product->product_name !!} </a> </div>
                                                                ...
                                                                <li class="item item-animate wide-first">
                                                                    <div class="item-inner">
                                                                        <div class="item-img col-sm-12" style="width: 400px;">
                                                                            ...
                                                                            <div class="item-info">
                                                                                <div class="info-inner">
                                                                                    <div class="item-title"><a href="#" title="Retis lapen casen">{!! $newProduct->product_name !!}</a> </div>
                                                                                    <div class="item-content">
                                                                                        <div class="item-price">
                                                                                            <div class="price-box"><span class="regular-price ">
                                                                                                    <span class="price text-center">TK. {!! $newProduct->product_price !!}</span> </span>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                            ...
                                                            @foreach($products as $product)
                                                                <li class="item item-animate wide-first">
                                                                    <div class="item-inner col-sm-12" style="width: 400px;">
                                                                        ...
                                                                        <div class="item-info">
                                                                            <div class="info-inner">
                                                                                <div class="item-title"><a href="#" title="Retis lapen casen">{!! $product->product_name !!}</a> </div>
                                                                                <div class="item-content">
                                                                                    <div class="item-price">
                                                                                        <div class="price-box"><span class="regular-price"><span class="price">Tk. {!! $product->product_price !!}</span> </span> </div>
                                                                                    </div>
                            ...
                            <div class="blog_post">
                                <div class="thumbnail">
                                    ...
                                    <div class="featured-img">
                                        ...
                                        <img src="{!! asset('/') !!}/front-end/images/blog-img1.jpg" alt="blog post">
                                    </div>
                                </div>
                                <div class="entry-meta">
                                    <a href="#">
                                        <span class="author-avatar byline"><img alt="" src="{!! asset('/') !!}/front-end/images/admin-photo.jpg" class="avatar avatar-96 photo">By John Doe</span> <span class="timestamp">January 26, 2016</span>
                                    </a>
                        ...
                        <div class="col-lg-6 col-md-6 col-xs-12 col-sm-6">
                            <div class="blog_post">
                                <div class="thumbnail">
                                    ...
                                    <div class="featured-img">
                                        <span class="gradient-overlay"></span>
                                        <img src="{!! asset('/') !!}/front-end/images/blog-img2.jpg"  alt="blog post 2">
                                ...
                                <div class="entry-meta">
                                    <a href="#">
                                        <span class="author-avatar byline"><img alt="" src="{!! asset('/') !!}/front-end/images/admin-photo1.jpg"  class="avatar avatar-96 photo">By Saraha Smith</span>
                                    </a>
