                                ...
                                <div class="product-img-box col-sm-4 col-xs-12">
                                    ...
                                    <div class="product-image">
                                        <div class="large-image"> <a href="products-images/product.jpg" class="cloud-zoom" id="zoom1">
                                                <img src="{!! asset($product->product_image) !!}" alt="product image"> </a> </div>
                                        <div class="flexslider flexslider-thumb">
                                            <ul class="previews-list slides">
                                                <li><a href='products-images/product.jpg' class='cloud-zoom-gallery' rel="useZoom: 'zoom1', smallImage: 'products-images/product.jpg' "><img src="{!! asset($product->product_image) !!}" alt = "Thumbnail 1"/></a></li>
                                                <li><a href='products-images/product.jpg' class='cloud-zoom-gallery' rel="useZoom: 'zoom1', smallImage: 'products-images/product.jpg' "><img src="{!! asset($product->product_image) !!}" alt = "Thumbnail 2"/></a></li>
                                                <li><a href='products-images/product.jpg' class='cloud-zoom-gallery' rel="useZoom: 'zoom1', smallImage: 'products-images/product.jpg' "><img src="{!! asset($product->product_image) !!}" alt = "Thumbnail 1"/></a></li>
                                                <li><a href='products-images/product.jpg' class='cloud-zoom-gallery' rel="useZoom: 'zoom1', smallImage: 'products-images/product.jpg' "><img src="{!! asset($product->product_image) !!}" alt = "Thumbnail 2"/></a></li>
                                                <li><a href='products-images/product.jpg' class='cloud-zoom-gallery' rel="useZoom: 'zoom1', smallImage: 'products-images/product.jpg' "><img src="{!! asset($product->product_image) !!}" alt = "Thumbnail 2"/></a></li>
                                                <li><a href='products-images/product.jpg' class='cloud-zoom-gallery' rel="useZoom: 'zoom1', smallImage: 'products-images/product.jpg' "><img src="{!! asset($product->product_image) !!}" alt = "Thumbnail 2"/></a></li>
                                            ...
                                            <div class="add-to-cart">
                                                <div class="pull-left">
                                                    <div class="custom pull-left">
                                                        ...
                                                        <input type="number" name="qty" class="input-text qty" min="1" title="Qty" value="" maxlength="12" id="qty">
                                                        <button onClick="var result = document.getElementById('qty'); var qty = result.value; if( !isNaN( qty )) result.value++;return false;" class="increase items-count" type="button"><i class="fa fa-plus">&nbsp;</i></button>
                                                        <input id="name" type="hidden" name="id"  value="{{ $product->id }}" class="form-control">
                                                    </div>
                                                </div>
                                                <button type="submit" name="btn" onClick="productAddToCartForm.submit(this)" class="button btn-cart" title="Add to Cart">
                            ...
                            <div class="product-collateral col-lg-12 col-sm-12 col-xs-12 bounceInUp animated">
                                <div class="add_info">
                                    <ul id="product-detail-tab" class="nav nav-tabs product-tabs">
                                        <li class="active"> <a href="#product_tabs_description" data-toggle="tab"> Product Long Description </a> </li>
