<ul class="navbar-nav bg-gradient-info sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ route('home') }}">
        ...
        <div class="sidebar-brand-text mx-3">Choice Online </div>
    </a>
    ...
    <li class="nav-item">
        <a class="nav-link" href="{!! route('manage-order') !!}">
            <i class="fas fa-fw fa-chart-area"></i><span>Manage Order</span>
        </a>
    </li>
    <!-- Divider -->
    ...
    <div class="sidebar-card d-none d-lg-flex">
        <img class="sidebar-card-illustration mb-2" src="{!! asset('/admin')!!}/dashboard/img/undraw_rocket.svg" alt="...">
